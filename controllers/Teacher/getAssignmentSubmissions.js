...
const GetAssignmentSubmissions = require('../../logic/Teacher/GetAssignmentSubmissions');
...
const getAssignmentSubmissions = async (req, res) => {
    try {
        ...
        let result = await GetAssignmentSubmissions(assignmentId, teacherId).catch(error => {
